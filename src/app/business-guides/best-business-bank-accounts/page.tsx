  ...
  return (
    <>
      ...
      <article className="mx-auto max-w-4xl px-4 py-10">
        ...
        <h1 className="mb-2 text-3xl font-extrabold text-gray-900 sm:text-4xl">Best Business Bank Accounts for Small Businesses</h1>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2>Best Business Checking Accounts (2025)</h2>

          <h3>Best Free Options</h3>
          <table>
            <thead>
              <tr><th>Bank</th><th>Monthly Fee</th><th>Free Transactions</th><th>Best For</th></tr>
            </thead>
            <tbody>
              <tr><td>Bluevine</td><td>$0</td><td>Unlimited</td><td>Online businesses</td></tr>
              <tr><td>Novo</td><td>$0</td><td>Unlimited</td><td>Freelancers &amp; startups</td></tr>
              <tr><td>Mercury</td><td>$0</td><td>Unlimited</td><td>Tech startups</td></tr>
              <tr><td>Relay</td><td>$0</td><td>Unlimited</td><td>Small teams</td></tr>
              <tr><td>Chase Business Complete</td><td>$15*</td><td>100/month</td><td>Brick-and-mortar</td></tr>
            </tbody>
          </table>
          <p><em>*Chase fee is waived with $2,000 minimum balance or $2,000 in deposits.</em></p>

          <h3>Best for High-Volume Businesses</h3>
          <table>
            <thead>
              <tr><th>Bank</th><th>Monthly Fee</th><th>Free Transactions</th><th>Best For</th></tr>
            </thead>
            <tbody>
              <tr><td>Chase Performance Business</td><td>$30*</td><td>250/month</td><td>Growing businesses</td></tr>
              <tr><td>Bank of America Business Advantage</td><td>$16*</td><td>200/month</td><td>Multi-location</td></tr>
              <tr><td>Wells Fargo Initiate Business</td><td>$10*</td><td>100/month</td><td>Existing Wells customers</td></tr>
            </tbody>
          </table>
          ...
          <ul>
            <li><strong>EIN</strong> &mdash; Get one free from the IRS (<Link href="/business-guides/how-to-get-ein" className="text-teal-600 hover:underline">EIN guide</Link>)</li>
            <li><strong>Articles of Organization</strong> &mdash; Filed when you <Link href="/business-guides/how-to-start-llc" className="text-teal-600 hover:underline">formed your LLC</Link></li>
          ...
          <table>
            ...
            <tbody>
              <tr><td>Monthly fees</td><td>Usually $0</td><td>$10-$30+</td></tr>
              <tr><td>Interest on balance</td><td>Often yes</td><td>Rarely</td></tr>
              <tr><td>In-person service</td><td>No</td><td>Yes</td></tr>
              <tr><td>Cash deposits</td><td>Limited/none</td><td>Easy</td></tr>
              <tr><td>Tech/integrations</td><td>Excellent</td><td>Good</td></tr>
              <tr><td>Best for</td><td>Online/service biz</td><td>Cash/retail biz</td></tr>
            </tbody>
          </table>
